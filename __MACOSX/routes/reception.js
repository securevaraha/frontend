  ...
  try {
    ...
    for (let i = 0; i < patients.length; i++) {
      ...
      reportData.push({
        ...
        registrationDate: patient.added_on
          ? new Date(patient.added_on).toLocaleDateString('en-GB', { timeZone: 'Asia/Calcutta' }).replace(/\//g, '-')
          : '',
        registrationTime: patient.added_on
          ? new Date(patient.added_on).toLocaleTimeString('en-IN', { timeZone: 'Asia/Calcutta', hour12: false })
          : ''
      });
    }
