      ...
      <section className="py-20 bg-gradient-to-br from-[#0056AE] to-[#2E92ED] text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{fontFamily: 'Roboto, sans-serif', fontWeight: 600}}>
            <span className="text-white">GSI (Dual Energy)</span> <span className="text-white">Services</span>
          </h1>
          <p className="text-xl max-w-3xl mx-auto" style={{fontFamily: 'Roboto, sans-serif'}}>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-16" style={{color: '#0056AE', fontFamily: 'Roboto, sans-serif', fontWeight: 600}}>
            <span className="text-white">DUAL ENERGY APPLICATIONS</span>
          </h2>
