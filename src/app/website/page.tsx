...
export default function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-teal-100 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-gray-700">24/7 Emergency Available</span>
              </div>
              ...
              <div className="flex gap-4 mb-12">
                <Link href="/website/appointment" className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-2xl font-bold hover:shadow-xl transition-all duration-300">
                  Book MRI/CT Scan
                </Link>
                <Link href="/website/services" className="bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 px-8 py-4 rounded-2xl font-bold hover:shadow-lg transition-all duration-300">
                  View Services
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="text-3xl font-black bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">15+</div>
                  <div className="text-gray-600 text-sm font-medium">Years Experience</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">50K+</div>
                  <div className="text-gray-600 text-sm font-medium">Scans Completed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">24/7</div>
                  <div className="text-gray-600 text-sm font-medium">Emergency Care</div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-teal-100 rounded-3xl p-8">
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-center text-white">
                    <h3 className="font-bold mb-2">3T MRI Scanner</h3>
                    <p className="text-blue-100 text-sm">High-resolution imaging</p>
                  </div>
                  <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-6 text-center text-white">
                    <h3 className="font-bold mb-2">64-Slice CT</h3>
                    <p className="text-teal-100 text-sm">Rapid scanning</p>
                  </div>
                </div>
                <div className="text-center">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Our Imaging?</h3>
      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-teal-600 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-white/30">
              ...
              <span className="font-semibold text-white text-sm">Patient Reviews</span>
            </div>
            <h2 className="text-3xl font-bold text-white mb-3">Trusted Healthcare Partner</h2>
            <p className="text-blue-100 max-w-xl mx-auto">What our patients say about their diagnostic experience</p>
          </div>
          
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/15 backdrop-blur-lg rounded-2xl p-6 border border-white/30">
              <div className="text-center">
                <div className="text-4xl mb-3">{testimonials[currentTestimonial].avatar}</div>
                ...
                <blockquote className="text-lg text-white mb-4 leading-relaxed font-medium">
                  "{testimonials[currentTestimonial].text}"
                </blockquote>
                
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 border border-white/30">
                  <div className="font-bold text-white">{testimonials[currentTestimonial].name}</div>
                  <div className="text-blue-200 text-sm">{testimonials[currentTestimonial].role}</div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-black text-gray-900 mb-6">Visit Our Modern Facility</h2>
              <p className="text-xl text-gray-600 mb-8">Conveniently located in Jodhpur with easy parking and accessibility.</p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Unit-1: Plot No. 06, Ram Nagar<br/>Sangriya, Jodhpur</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon-Fri: 7:00 AM - 9:00 PM<br/>Sat-Sun: 8:00 AM - 6:00 PM<br/>Emergency: 24/7</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 7014265848<br/>techroverteam@gmail.com</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-8">
                <Link href="/website/contact" className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-2xl font-bold hover:shadow-xl transition-all duration-300">
                  Get Directions
                </Link>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-100 to-teal-100 rounded-2xl p-8">
              <div className="h-64 bg-gradient-to-br from-blue-200 to-teal-200 rounded-xl mb-6 flex items-center justify-center">
                <iframe 
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Unit-1: Plot No. 06, Ram Nagar, Sangriya, Jodhpur</p>
                <Link href="https://maps.google.com/search/Unit-1+Plot+No+06+Ram+Nagar+Sangriya+Jodhpur" target="_blank" className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-6 py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300">
                  Open in Google Maps
                </Link>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-teal-600 py-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/website/appointment" className="group bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
              <svg className="w-5 h-5 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
              </svg>
              Book Appointment
            </Link>
            <Link href="tel:+917014265848" className="group bg-white/10 backdrop-blur-sm border border-white/30 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2">
