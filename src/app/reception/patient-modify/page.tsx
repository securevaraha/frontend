...
export default function PatientModify() {
  ...
  const fetchPatients = async (from: string, to: string) => {
    ...
    try {
      ...
      const response = await fetch(`https://api.varahasdc.co.in/admin/patient-list?from_date=${fromFormatted}&to_date=${toFormatted}`);
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`https://api.varahasdc.co.in/admin/patients/${editingPatient.patient_id}`, {
        method: 'PUT',
  ...
  const toggleScanStatus = async (patient: Patient) => {
    ...
    try {
      const response = await fetch(`https://api.varahasdc.co.in/admin/patients/${patient.patient_id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
